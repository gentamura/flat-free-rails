module FuiTileHelper
  def fui_tile(icon_type, title, content, button_type, button_text, button_link, ribbon = false)
    content_tag(:div, class: 'tile') do
      concat tag :img, src: "/assets/icons/svg/ribbon.svg", alt: "ribbon", class: "tile-hot-ribbon" if ribbon
